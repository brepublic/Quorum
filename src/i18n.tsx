...
const en: Record<string, string> = {
  ...
  "General speakers list missing": "General Speaker's List missing",
  "Speakers list closed": "The General Speaker's List is closed",
  "Speakers list complete": "The General Speaker's List has ended",
  "The previous session’s general speakers list could not be restored. Create a new list and continue?": "The previous session’s General Speaker's List could not be restored. Create a new list and continue?",
...
const zhCN: Record<string, string> = {
  ...
  "This will replace the current version. Resolutions and amendments that reference this file will use the new version.": "将替换此文件的当前版本，引用它的决议和修正案将同步更新。",
  ...
  'Discuss resolution': '讨论决议草案',
  'Postpone resolution': '暂缓审议决议草案',
  'Resume resolution': '恢复审议决议草案',
