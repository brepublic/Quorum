...
const zhCN: Record<string, string> = {
  ...
  'Active theme': '当前主题',
  'Themes can completely restyle and rearrange the interface, but cannot change Quorum data or behavior.': '主题可以彻底重塑并重新编排界面，但不能改变 Quorum 的数据或业务行为。',
  'Imported themes stay in this browser. Theme files contain CSS only and never write to Firebase.': '导入的主题仅保存在当前浏览器中。主题文件只包含 CSS，绝不会写入 Firebase。',
  'Import theme': '导入主题',
  ...
  'Unsupported theme schema. Expected quorum-theme version 1.': '不支持此主题格式，应为 quorum-theme 版本 1。',
