...
const zhCN: Record<string, string> = {
  ...
  'Country name': '国家名称',
  'Search codes': '检索代码',
  'Search codes (comma-separated)': '检索代码（用逗号分隔）',
  'Save search codes': '保存检索代码',
  'Search codes saved': '检索代码已保存。',
  'Search index': '搜索索引',
  'Rebuild search index': '重建搜索索引',
  'Indexed options': '已索引选项',
  ...
  'Names and flags of built-in countries are read-only. Clone the template to change them.': '内置国家的名称与国旗不可直接修改；需要修改时请克隆模板。',
