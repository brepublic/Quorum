  ...
  render() {
    ...
    return (
      <Form.Input
        ...
        placeholder={props.placeholder || t('Duration')}
      ...
      >
        ...
        <Select 
          ...
          options={UNIT_OPTIONS.map(option => ({ ...option, text: t(String(option.text)) }))}
          compact 
          button 
          onChange={props.onUnitChange} 
        />
        {props.onSet && (<Button onClick={handleOnSet}>{t('Set')}</Button>)}
      </Form.Input>
    );
  }
}
