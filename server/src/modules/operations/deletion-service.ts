...
export const COMMITTEE_PURGE_QUERIES = [
  ...
  `DELETE FROM strawpoll_seat_vote_revisions WHERE strawpoll_id IN (SELECT id FROM strawpolls WHERE committee_id=$1)`,
  `DELETE FROM strawpoll_manual_tally_revisions WHERE strawpoll_id IN (SELECT id FROM strawpolls WHERE committee_id=$1)`,
  ...
  `DELETE FROM motion_direct_vote_revisions WHERE committee_id=$1`,
  `DELETE FROM motion_direct_vote_setting_revisions WHERE committee_id=$1`,
  `DELETE FROM motion_direct_votes WHERE committee_id=$1`,
  ...
  `DELETE FROM resolution_direct_vote_revisions WHERE committee_id=$1`,
  `DELETE FROM resolution_setting_revisions WHERE committee_id=$1`,
