...
export const COMMITTEE_EVENT_DEFINITIONS = [
  ...
  {name: 'motion_settings.changed', defaultAudience: 'MEMBER'},
  ...
  {name: 'meeting_session.created', defaultAudience: 'MEMBER'},
  ...
  {name: 'point.withdrawn', defaultAudience: 'MEMBER'},
  ...
  {name: 'speaker_list.changed', defaultAudience: 'MEMBER'},
  ...
  {name: 'speech.yield_decision_changed', defaultAudience: 'MEMBER'},
  ...
  {name: 'motion.voting_started', defaultAudience: 'MEMBER'},
  {name: 'motion.direct_vote_settings_changed', defaultAudience: 'MEMBER'},
  {name: 'motion.direct_vote_changed', defaultAudience: 'MEMBER'},
  ...
  {name: 'ballot.vote_changed', defaultAudience: 'CHAIR'},
  {name: 'ballot.result_published', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.created', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.round_created', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.stage_changed', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.settings_changed', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.vote_recorded', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.vote_changed', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.manual_tally_changed', defaultAudience: 'PUBLIC'},
  {name: 'strawpoll.closed', defaultAudience: 'PUBLIC'},
  {name: 'document.created', defaultAudience: 'MEMBER'},
  {name: 'document.deleted', defaultAudience: 'MEMBER'},
  {name: 'document.version_created', defaultAudience: 'MEMBER'},
  {name: 'document.status_changed', defaultAudience: 'PUBLIC'},
  {name: 'document.settings_changed', defaultAudience: 'MEMBER'},
  {name: 'document.direct_vote_changed', defaultAudience: 'MEMBER'},
  {name: 'document.result_recorded', defaultAudience: 'PUBLIC'},
  ...
  {name: 'file.rejected', defaultAudience: 'CHAIR'},
  {name: 'file.published', defaultAudience: 'PUBLIC'},
  {name: 'file.sync_state_changed', defaultAudience: 'MEMBER'},
  {name: 'file.deleted', defaultAudience: 'MEMBER'},
  {name: 'storage.migration_created', defaultAudience: 'CHAIR'},
  {name: 'storage.migration_retried', defaultAudience: 'CHAIR'},
  {name: 'storage.migration_ready', defaultAudience: 'CHAIR'},
  {name: 'storage.migration_failed', defaultAudience: 'CHAIR'},
...
export const AUDIT_ACTION_DEFINITIONS = [
  ...
  'committee.motion_settings_changed',
  ...
  'proceedings.speaker_list_updated',
  'proceedings.speaker_list_status_changed',
  'proceedings.speaker_joined_queue',
  'proceedings.speaker_removed_from_queue',
  ...
  'proceedings.speech_yield_offered',
  'proceedings.speech_yield_accepted',
  'proceedings.speech_yield_rejected',
  'proceedings.speech_contribution_recorded',
  'proceedings.motion_proposed',
  'proceedings.motion_seconded',
  'proceedings.motion_voting_started',
  'proceedings.motion_direct_vote_settings_changed',
  'proceedings.motion_direct_vote_changed',
  ...
  'voting.strawpoll_round_created',
  'voting.strawpoll_stage_changed',
  'voting.strawpoll_manual_tally_changed',
  ...
  'documents.settings_changed',
  'documents.direct_vote_changed',
  'documents.result_recorded',
  ...
  'storage.file_review_requested',
  'storage.file_rejected',
  'storage.delegate_file_settings_updated',
  'storage.file_published',
  'storage.delegate_file_share_started',
  'storage.delegate_file_share_ended',
  'storage.delegate_file_identity_claimed',
  'storage.migration_created',
  'storage.migration_retried',
  'storage.migration_completed',
  'storage.migration_cancelled',
  'storage.provider_config_created',
  'storage.provider_config_updated',
  'storage.provider_config_verified',
